    ...
    return (
        <div className="relative w-full min-h-screen">
            <div className="absolute w-full mx-auto h-screen overflow-y-hidden flex justify-center items-center">
                <Image src="/next-img.png" alt="hero image" width={1992} height={900} className="brightness-60"/>
            </div>
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-shadow-2xss">
